      ...
      register('announcement-bar', {
        ...
        onLoad() {
          ...
          if (announcements.length > 1) {
            module.import('./index-9980138d.nomodule.js').then(function (n) { return n.i; }).then(({
              default: Flickity
            }) => {
    ...
    `);
      ...
      register('slideshow', {
        ...
        onLoad() {
          ...
          if (parallax == 'true') {
            module.import('./simpleParallax.min-59ee44b3.nomodule.js').then(function (n) { return n.s; }).then(({
      ...
      register('video', {
        onLoad() {
          ...
          const firstPlayClick = () => {
            module.import('./fluorescent-video.es-eaf88388.nomodule.js').then(({
              default: Video
            }) => {
      ...
      const filterHandler = ({
        ...
        let filters = null;
        let delegate = null;
        module.import('./filtering-48307cfc.nomodule.js').then(({
          default: filtering
        }) => {
...
//# sourceMappingURL=theme-2d172b3c.nomodule.js.map
