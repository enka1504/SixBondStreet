      ...
      register('announcement-bar', {
        ...
        onLoad() {
          ...
          if (announcements.length > 1) {
            module.import('./index-c3642172.nomodule.js').then(function (n) { return n.i; }).then(({
              default: Flickity
            }) => {
    ...
    `);
      ...
      register('slideshow', {
        ...
        onLoad() {
          ...
          if (parallax == 'true') {
            module.import('./simpleParallax.min-74d0b92d.nomodule.js').then(function (n) { return n.s; }).then(({
      ...
      register('video', {
        onLoad() {
          ...
          const firstPlayClick = () => {
            module.import('./fluorescent-video.es-9c049b38.nomodule.js').then(({
              default: Video
            }) => {
      ...
      const filterHandler = ({
        ...
        let filters = null;
        let delegate = null;
        module.import('./filtering-2b777d7d.nomodule.js').then(({
          default: filtering
        }) => {
...
//# sourceMappingURL=theme-c21075e0.nomodule.js.map
